...
RSpec.configure do |config|
  config.before(:each) do
    ...
    stub_request(:post, "https://sandbox.zenodo.org/api/deposit/depositions?access_token=0000-0000-0000-0000-0000-0000-0000").
      with(:body => '{"metadata":{"title":"Profound thoughts","upload_type":"publication","publication_type":"article","description":"A brief idea","creators":[{"name":"John Doe","affiliation":"","orcid":"0000-0000-0000-1234"}],"keywords":["Physics \\u003e Astrology"],"communities":[{"identifier":"briefideas"}],"license":"cc-by"}}',
           :headers => {'Accept'=>'application/json', 'Accept-Encoding'=>'gzip, deflate', 'Content-Length'=>'310', 'Content-Type'=>'application/json', 'User-Agent'=>'Ruby'}).
